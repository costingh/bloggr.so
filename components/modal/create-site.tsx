...
const fieldMappings = [
  ...
  {
    name: "Slug",
    description: "Slug for the post, or autogenerated from title if left empty",
  },
  {
    name: "Draft",
...
export default function CreateSiteModal() {
  ...
  const extractMapping = (notionDatabaseProperties: any) => {
    ...
    fieldMappings.forEach((field) => {
      ...
      const notionPropertyName = Object.keys(notionDatabaseProperties).find(
        (propertyName) => possibleFieldNames.includes(propertyName),
      );
      if (notionPropertyName) {
        _mapping[field.name] = notionPropertyName;
      } else {
        console.log(`No matching property found for field "${field.name}"`);
      }
    });
  ...
  const getPossibleFieldNames = (fieldName: string): string[] => {
    switch (fieldName) {
      ...
      case "Published Date":
        return ["Published Date", "Publish Date", "Date", "Release Date"];
      case "Slug":
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form className="grid w-full items-center gap-4">
            ...
            <>
              {fieldMappings.map((field, index) => (
                <React.Fragment key={index}>
                  ...
                  <div className={"flex flex-row gap-3"} key={field.name}>
                    ...
                    <div style={{ width: "150px" }}>
                      <div className="flex flex-col space-y-1.5">
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleChangeMapping(value, field.name)
                          }
                        >
              ...
              {databaseConnected && !isMappingValid && (
                ...
                >
                  Please select correct mapping for mandatory fields
                </span>
              )}
            </>
          )}
          ...
          {step == 3 && (
            <>
              <div className="flex flex-col space-y-1.5">
                <Label htmlFor="name">Enter your blog's name</Label>
                <Input
                  id="name"
                  name="name"
                  type="text"
              ...
              <div className="flex flex-col space-y-2">
                <Label htmlFor="name">Enter your desired subdomain</Label>
      ...
      <CardFooter>
        ...
        {step == 3 && (
          <Button className="w-full" disabled={pending} onClick={createBlog}>
