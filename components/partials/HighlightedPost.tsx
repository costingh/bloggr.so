        ...
        <Link href={`/${post.slug}`}>
            <div className="mb-20  grid place-items-center lg:grid-cols-2">
                ...
                <div className="pl-0 lg:p-10">
                    <span className="font-bold text-gray-600">Resources</span>

                    <Text
                        className=" block text-[25px] font-black leading-[30px] text-gray-800 hover:text-indigo-600 lg:text-[45px] lg:leading-[50px]"
                        color={primaryTextColor}
                    >
                        {post.title}
                    </Text>
                    <div className="mb-2 mt-2 lg:mb-4 lg:mt-6">
                        <span className="mr-4 text-[11px] text-gray-500">
                            {post.date}
                        </span>
                        ...
                        {post.categories.map((category, i) => (
                            <Link
                                ...
                                className="mr-2 cursor-pointer rounded-full bg-gray-200 px-2 py-[4px] text-[11px] font-bold text-gray-500 transition hover:bg-gray-300"
                                key={`category-${i}`}
                            >
                                {humanize(category)}
                            </Link>
                    ...
                    <Text
                        ...
                        className="my-[20px] text-[15px] font-medium text-zinc-800"
                    >
                        {post.content &&
