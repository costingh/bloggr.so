export const brandName = "Bloggr";
export const landingPageTitle = "Bloggr";
export const landingPageDescription = "Launch your blog in seconds";
export const websiteUrl = "http://localhost:3000";
export const supportEmail = "support@bloggr.so";
...
export const demoCalendlyLink = "https://calendly.com/gheorghecostin221/30min";

// used by MailChimp, Loops, and MailPace
export const emailFrom = "no-reply@bloggr.so";

// social links
export const discordLink = "https://discordlink";
export const twitterLink = "https://x.com/bloggr.so";
export const youTubeLink = "https://youtube.com/bloggr.so";
...
export const cannyUrl = "https://bloggr.canny.io/";
